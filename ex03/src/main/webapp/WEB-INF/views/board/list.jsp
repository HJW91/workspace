...
<%@ include file="../includes/header.jsp" %>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" >
                                <thead>
                                    <tr>
                                        ...
                                        <th>제목</th>
                                        <th>작성자</th>
                                        <th>작성일${pageMaker.startPage }</th>
                                        <th>수정일${pageMaker.endPage }</th>
                                    </tr>
                                </thead>
            ...
            <script type="text/javascript">
            	$(document).ready(function(){
            		...
            		history.replaceState({},null,null);		// 모달창 문제로 추가된 코드(p.257)
            		
            		function checkModal(result){
            			//if(result === ''){
            			if(result === ''|| history.state){	// 모달창 문제로 추가된 코드(p.257)
            				return;
            			}
